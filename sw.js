...
const VERSION = 'the-v80-20260720-ios-safe';
...
const CORE_ASSETS = [
  ...
  'manifest.json', 'icon-the.svg', 'icon-192.png', 'icon-maskable-512.png', 'apple-touch-icon.png', 'logo-the.png', 'logo-threshold.png', 'the-footer.js', 'the-pass.js', 'the-lightbox.js', 'the-print.js', 'the-souvenir.js', 'the-i18n.js', 'the-backup.js', 'immersion-rome.mp3',
