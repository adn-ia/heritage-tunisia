/* THE — sauvegarde / restauration locale des données utilisateur.
...
(function(){
  ...
  async function importFile(file){
    ...
    if(!data || data.app!=='THE') throw new Error('Fichier non reconnu (ce n’est pas une sauvegarde THE).');
  ...
  window.THEBackup={ exportAll:exportAll, download:download, importFile:importFile };
})();
